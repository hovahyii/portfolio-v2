(function($) {
    ...
    if ($('#upload-btn').length > 0) {
      ...
      var uploader = new ss.SimpleUpload({
        ...
        onSizeError: function(filename, fileSize) {
          errBox.innerHTML = 'Max size 25MB';
        },
  ...
  function initTyped() {
    $("#typed").typed({
      strings: ["A Problem Solver", "A Freelancer", "A Full Stack Developer", "A Mobile Application Developer", "A Digital Marketer"],
      // typing speed
      typeSpeed: 300,
